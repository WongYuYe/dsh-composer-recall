...
```bash
bash open-pokemon-claw/scripts/run-frontend-prod.sh
```
...
```bash
bash open-pokemon-claw/scripts/check-live-health.sh
```
...
```bash
bash open-pokemon-claw/scripts/deploy-frontend-prod.sh
```
